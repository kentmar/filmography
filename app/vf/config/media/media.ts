  ...
  versions: [
    {
      ...
      width: 2048,
      height: 624,
      layers: parsePositiveInt(import.meta.env.VITE_MEDIA_VERSION_0_LAYERS, 1),
    ...
    },
    {
      ...
      width: 1980,
      height: 1980,
      layers: parsePositiveInt(import.meta.env.VITE_MEDIA_VERSION_1_LAYERS, 10),
    ...
    },
    {
      ...
      width: 1980,
      height: 1980,
      layers: parsePositiveInt(import.meta.env.VITE_MEDIA_VERSION_2_LAYERS, 241),
